...
public abstract class VunglePubBase {
    ...
    public boolean init(Context context, String str) {
        ...
        if (z) {
            try {
                Logger.d(GNSAdapterVungleRewardVideoAd.TAG, "already initialized");
                return z;
            } catch (Throwable e) {
                Logger.e(GNSAdapterVungleRewardVideoAd.TAG, "VunglePub initialization failed", e);
                return z;
            }
        }
        ...
        if (a) {
            Object obj;
            if (this.o) {
                Logger.d(GNSAdapterVungleRewardVideoAd.TAG, "already injected");
            } else {
                ...
                Injector.b().a(this);
                Logger.d(GNSAdapterVungleRewardVideoAd.TAG, "injection successful");
                this.o = true;
            }
            ...
            if (obj != null) {
                Logger.i(GNSAdapterVungleRewardVideoAd.TAG, "VungleDroid/4.0.3 init(" + str + ")");
                qu quVar = this.c;
                ...
                Logger.v(GNSAdapterVungleRewardVideoAd.TAG, "initialization successful");
                this.p = true;
                return true;
            }
            Logger.w(GNSAdapterVungleRewardVideoAd.TAG, "initialization failed");
        }
        return z;
    }
    ...
    public String[] getMissingPermissions() {
        ...
        try {
            ...
            Logger.e(GNSAdapterVungleRewardVideoAd.TAG, "error getting missing permissions", e);
        }
        return strArr;
    }
    ...
    private boolean a(boolean z, String str) {
        boolean z2 = this.p;
        if (z2) {
            Logger.v(GNSAdapterVungleRewardVideoAd.TAG, "VunglePub was initialized");
        } else if (z) {
            Logger.w(GNSAdapterVungleRewardVideoAd.TAG, "Please call VunglePub.init() before " + str);
        }
        return z2;
    }
    ...
    private boolean a() {
        boolean z = this.o;
        if (!z) {
            Logger.d(GNSAdapterVungleRewardVideoAd.TAG, "VunglePub not injected");
        }
        return z;
    }
    ...
    public Demographic getDemographic() {
        try {
            ...
            Logger.e(GNSAdapterVungleRewardVideoAd.TAG, "error getting demographic info", e);
        }
        return this.e;
    }
    ...
    public void addEventListeners(EventListener... eventListenerArr) {
        try {
            ...
            Logger.e(GNSAdapterVungleRewardVideoAd.TAG, "error adding event listeners", e);
        }
    }
    ...
    public void setEventListeners(EventListener... eventListenerArr) {
        try {
            ...
            Logger.e(GNSAdapterVungleRewardVideoAd.TAG, "error setting event listeners", e);
        }
    }
    ...
    public void clearEventListeners() {
        try {
            ...
            Logger.e(GNSAdapterVungleRewardVideoAd.TAG, "error clearing event listeners", e);
        }
    }
    ...
    public void removeEventListeners(EventListener... eventListenerArr) {
        try {
            ...
            Logger.e(GNSAdapterVungleRewardVideoAd.TAG, "error removing event listeners", e);
        }
    }
    ...
    public AdConfig getGlobalAdConfig() {
        try {
            ...
            Logger.e(GNSAdapterVungleRewardVideoAd.TAG, "error getting globalAdConfig", e);
        }
        return this.h;
    }
    ...
    public void onResume() {
        try {
            ...
            Logger.e(GNSAdapterVungleRewardVideoAd.TAG, "error onResume()", e);
        }
    }
    ...
    public void onPause() {
        try {
            ...
            Logger.e(GNSAdapterVungleRewardVideoAd.TAG, "error onPause()", e);
        }
    }
    ...
    public boolean isAdPlayable() {
        ...
        try {
            ...
            Logger.e(GNSAdapterVungleRewardVideoAd.TAG, "error returning ad playable", e);
        }
        return z;
    }
