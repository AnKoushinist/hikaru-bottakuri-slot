...
public final class aaz implements MembersInjector<a> {
    static final /* synthetic */ boolean a = (!aaz.class.desiredAssertionStatus());
    ...
    private aaz(Provider<pn> provider, Provider<sr> provider2, Provider<pu> provider3, Provider<String> provider4, Provider<WrapperFramework> provider5, Provider<String> provider6, Provider<adn.a> provider7) {
        if (a || provider != null) {
            this.b = provider;
            if (a || provider2 != null) {
                this.c = provider2;
    ...
    public static MembersInjector<a> a(Provider<pn> provider, Provider<sr> provider2, Provider<pu> provider3, Provider<String> provider4, Provider<WrapperFramework> provider5, Provider<String> provider6, Provider<adn.a> provider7) {
        return new aaz(provider, provider2, provider3, provider4, provider5, provider6, provider7);
    }
}
