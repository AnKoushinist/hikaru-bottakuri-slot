...
public final class zs implements MembersInjector<a> {
    static final /* synthetic */ boolean a = (!zs.class.desiredAssertionStatus());
    ...
    public final /* synthetic */ void injectMembers(Object obj) {
        ...
        aVar.g = (adn.a) this.h.get();
    }

    private zs(Provider<pn> provider, Provider<sr> provider2, Provider<pu> provider3, Provider<String> provider4, Provider<WrapperFramework> provider5, Provider<String> provider6, Provider<adn.a> provider7) {
        if (a || provider != null) {
            this.b = provider;
            if (a || provider2 != null) {
                this.c = provider2;
    ...
    public static MembersInjector<a> a(Provider<pn> provider, Provider<sr> provider2, Provider<pu> provider3, Provider<String> provider4, Provider<WrapperFramework> provider5, Provider<String> provider6, Provider<adn.a> provider7) {
        return new zs(provider, provider2, provider3, provider4, provider5, provider6, provider7);
    }
}
