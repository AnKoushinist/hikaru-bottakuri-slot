...
class b {
    ...
    private PendingIntent a(Bundle bundle, PendingIntent pendingIntent) {
        ...
        return g.b(this.b, a(), intent, 1073741824);
    }
    ...
    private int b(String str) {
        ...
        identifier = b().getInt("com.google.firebase.messaging.default_notification_icon", 0);
        if (identifier == 0) {
    ...
    private Integer c(String str) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            if (i != 0) {
                try {
                    num = Integer.valueOf(android.support.v4.a.b.c(this.b, i));
    ...
    private Notification d(Bundle bundle) {
        ...
        d a = new d(this.b).b(true).a(b);
        if (TextUtils.isEmpty(d)) {
            a.a(this.b.getApplicationInfo().loadLabel(this.b.getPackageManager()));
        } else {
            a.a(d);
        }
