...
public class TapjoyConstants {
    ...
    public static final int MEDIATION_TIMEOUT_INTERVAL = 20;
    ...
    public static final String TAPJOY_MEDIATION_HEADER = "X-Tapjoy-Mediation-Content";
    ...
    public static final String TJC_BRIDGE_VERSION_NUMBER = "1.0.8";
    ...
    public static final int TJC_LIBRARY_VERSION_INT = 11100;
    public static final String TJC_LIBRARY_VERSION_NUMBER = "11.10.0";
    ...
    public static final String TJC_PERSISTENT_ID_DISABLED = "persistent_ids_disabled";
    ...
    public static final String[] dependencyClassNames = new String[]{"com.tapjoy.TJAdUnitActivity", "com.tapjoy.TJContentActivity", "com.tapjoy.mraid.view.ActionHandler", "com.tapjoy.mraid.view.Browser"};
    public static final String[] dependencyPermissions;
    public static final String[] optionalPermissions = new String[]{"android.permission.ACCESS_FINE_LOCATION", "android.permission.ACCESS_COARSE_LOCATION", "android.permission.READ_PHONE_STATE", "android.permission.ACCESS_WIFI_STATE"};

    static {
        String[] strArr = new String[TJC_MM_INTERSTITIAL];
        strArr[TJC_NO_VIEW] = "android.permission.INTERNET";
        strArr[TJC_AD_VIEW] = "android.permission.ACCESS_NETWORK_STATE";
        dependencyPermissions = strArr;
    }
}
