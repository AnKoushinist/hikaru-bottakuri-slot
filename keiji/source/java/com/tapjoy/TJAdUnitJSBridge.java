...
public class TJAdUnitJSBridge {
    ...
    public void displayRichMedia(final JSONObject jSONObject, String str) {
        ...
        try {
            string = jSONObject.getString(String.HTML);
        } catch (Exception e2) {
            e2.printStackTrace();
            string = null;
        }
    ...
    public void initMoatVideoTracker(JSONObject jSONObject, String str) {
        if (this.c instanceof TJAdUnitActivity) {
            try {
                this.k = (ReactiveVideoTracker) MoatFactory.create((TJAdUnitActivity) this.c).createCustomTracker(new ReactiveVideoTrackerPlugin(jSONObject.getString(String.PARTNER_CODE)));
                if (this.l == null) {
        ...
        try {
            ...
            this.m.post(new Runnable(this) {
                ...
                public final void run() {
                    ...
                    this.d.invokeJSCallback(str, Boolean.valueOf(trackVideoAd));
                }
            });
        } catch (Exception e) {
