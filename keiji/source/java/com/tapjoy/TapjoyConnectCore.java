...
public class TapjoyConnectCore {
    ...
    public static void requestTapjoyConnect(Context context, String str, Hashtable hashtable, TJConnectListener tJConnectListener) {
        try {
            eq eqVar = new eq(str);
            if (eqVar.a != com.tapjoy.internal.eq.a.SDK_ANDROID) {
    ...
    private static void f() {
        if (!ct.c(O)) {
            fz.a().a(g, h, com.tapjoy.mraid.BuildConfig.VERSION_NAME, TapjoyConfig.TJC_ANALYTICS_SERVICE_URL, O, N);
        }
        if (k != null) {
            k.onConnectFailure();
        }
    ...
    public static Map getGenericURLParams() {
        Map g = g();
        TapjoyUtil.safePut(g, GNSAdapterVungleRewardVideoAd.APP_ID_COLUMN_NAME, w, true);
        return g;
    }
    ...
    private static Map g() {
        ...
        TapjoyUtil.safePut(hashMap3, GNSAdapterVungleRewardVideoAd.APP_ID_COLUMN_NAME, w, true);
        ...
        TapjoyUtil.safePut(hashMap3, TapjoyConstants.TJC_DEVICE_DISPLAY_DENSITY, aM);
        TapjoyUtil.safePut(hashMap3, TapjoyConstants.TJC_DEVICE_DISPLAY_WIDTH, aN);
        TapjoyUtil.safePut(hashMap3, TapjoyConstants.TJC_DEVICE_DISPLAY_HEIGHT, aO);
        ...
        TapjoyUtil.safePut(hashMap3, TapjoyConstants.TJC_PACKAGE_REVISION, ao);
            ...
            if (m.size() == 0) {
                ...
                try {
                    try {
                        ...
                        if (str == null) {
                            copyTextFromJarIntoString = TapjoyUtil.copyTextFromJarIntoString("js/mraid.js", g);
                        } else {
                            copyTextFromJarIntoString = str;
                        }
                        if (copyTextFromJarIntoString == null) {
                            try {
                                InputStream openRawResource = g.getResources().openRawResource(g.getResources().getIdentifier("mraid", "raw", g.getPackageName()));
    ...
    private static boolean a(String str, boolean z) {
        ...
        try {
            ...
            try {
                Map d = b.d();
                String a = ct.a((String) d.get(TapjoyConstants.TJC_APP_GROUP_ID));
                String a2 = ct.a((String) d.get(TapjoyConstants.TJC_STORE));
                String a3 = ct.a((String) d.get(TapjoyConstants.TJC_ANALYTICS_API_KEY));
                String a4 = ct.a((String) d.get(TapjoyConstants.TJC_MANAGED_DEVICE_ID));
                String a5 = ct.a((String) d.get(TapjoyConstants.TJC_PACKAGE_NAMES));
                Object obj = d.get("cache_max_age");
                eq eqVar = new eq(a3);
                if (eqVar.a != com.tapjoy.internal.eq.a.RPC_ANALYTICS) {
                ...
                if (str2.regionMatches(13, "-8000-8000-", 0, 11)) {
                    ...
                    fz.a().a(g, a3, com.tapjoy.mraid.BuildConfig.VERSION_NAME, TapjoyConfig.TJC_ANALYTICS_SERVICE_URL, stringBuffer, str4);
                    U = str3;
                    V = a2;
                    W = a3;
                    X = a4;
                    ...
                    if (!z) {
                        try {
                            ...
                            if (obj2 instanceof Map) {
                                try {
                                    a6.a.a((Map) obj2);
                                    a6.c().edit().putString(TapjoyConstants.PREF_SERVER_PROVIDED_CONFIGURATIONS, bm.a(obj2)).apply();
                                } catch (Exception e5) {
                                }
                            } else if (obj2 == null) {
                                a6.a.a(null);
    ...
    public void actionComplete(String str) {
        ...
        Map g = g();
        TapjoyUtil.safePut(g, GNSAdapterVungleRewardVideoAd.APP_ID_COLUMN_NAME, str, true);
