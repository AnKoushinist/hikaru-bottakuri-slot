...
public final class hq extends RelativeLayout implements OnClickListener {
    private boolean a;
    ...
    public hq(Context context, gu guVar, a aVar) {
        int i = 1;
        super(context);
        this.h = guVar;
        this.i = aVar;
        ...
        if (this.h.m != null) {
            gv gvVar = this.h.m;
            if (gvVar.a == null || (gvVar.b == null && gvVar.c == null)) {
                i = 0;
            }
            if (i != 0) {
                this.g = new hn(context2);
        ...
        this.f.setImageBitmap(guVar.c.b);
        if (this.g != null && guVar.m != null && guVar.m.a != null) {
            this.g.setImageBitmap(guVar.m.a.b);
        }
    }
    ...
    public final void onClick(View view) {
        if (view == this.f) {
            ...
            hnVar.invalidate();
            this.i.b();
        } else if (view.getTag() instanceof gs) {
            this.i.a((gs) view.getTag());
        }
    }
}
