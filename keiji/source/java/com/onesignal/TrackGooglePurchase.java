...
class TrackGooglePurchase {
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        Bundle bundle = (Bundle) TrackGooglePurchase.this.getPurchasesMethod.invoke(TrackGooglePurchase.this.mIInAppBillingService, new Object[]{Integer.valueOf(3), TrackGooglePurchase.this.appContext.getPackageName(), "inapp", null});
    ...
    private void sendPurchases(ArrayList<String> arrayList, final ArrayList<String> arrayList2) {
        try {
            ...
            Bundle bundle = (Bundle) this.getSkuDetailsMethod.invoke(this.mIInAppBillingService, new Object[]{Integer.valueOf(3), this.appContext.getPackageName(), "inapp", bundle});
            if (bundle.getInt("RESPONSE_CODE") == 0) {
                String string;
