...
class OneSignalStateSynchronizer {
    ...
    class UserState {
        ...
        private JSONObject generateJsonDiff(UserState userState, boolean z) {
            ...
            try {
                if (!access$200.has(GNSAdapterVungleRewardVideoAd.APP_ID_COLUMN_NAME)) {
                    access$200.put(GNSAdapterVungleRewardVideoAd.APP_ID_COLUMN_NAME, (String) this.syncValues.opt(GNSAdapterVungleRewardVideoAd.APP_ID_COLUMN_NAME));
                }
            } catch (JSONException e) {
                e.printStackTrace();
            }
