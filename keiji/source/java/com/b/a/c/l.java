...
class l implements UncaughtExceptionHandler {
    ...
    private static final class c implements Runnable {
        ...
        public void run() {
            if (i.n(this.a.E())) {
                a.a.a.a.c.h().a("CrashlyticsCore", "Attempting to send crash report at time of crash...");
                n a = this.a.a(q.a().b());
                if (a != null) {
    ...
    l(UncaughtExceptionHandler uncaughtExceptionHandler, g gVar, o oVar, ad adVar, a.a.a.a.a.f.a aVar, f fVar) {
    ...
    public synchronized void uncaughtException(final Thread thread, final Throwable th) {
        this.k.set(true);
        try {
            a.a.a.a.c.h().a("CrashlyticsCore", "Crashlytics is handling uncaught exception \"" + th + "\" from thread " + thread.getName());
            this.p.b();
            ...
            a.a.a.a.c.h().e("CrashlyticsCore", "An error occurred in the uncaught exception handler", e);
        } finally {
            a.a.a.a.c.h().a("CrashlyticsCore", "Crashlytics completed exception processing. Invoking default exception handler.");
    ...
    boolean c() {
        return ((Boolean) this.l.a(new Callable<Boolean>(this) {
            ...
            public Boolean a() {
                if (this.a.k.get()) {
                    a.a.a.a.c.h().a("CrashlyticsCore", "Skipping session finalization because a crash has already occurred.");
                    return Boolean.FALSE;
                }
                a.a.a.a.c.h().a("CrashlyticsCore", "Finalizing previously open sessions.");
                com.b.a.c.a.a.d v = this.a.n.v();
                if (v != null) {
                    this.a.a(v);
                }
                this.a.a(true);
                a.a.a.a.c.h().a("CrashlyticsCore", "Closed all previously open sessions");
                return Boolean.TRUE;
            }
        })).booleanValue();
    }
    ...
    private void l() {
        ...
        a.a.a.a.c.h().a("CrashlyticsCore", "Opening an new session with ID " + cVar);
        a(cVar, date);
        c(cVar);
        d(cVar);
        e(cVar);
    ...
    private void a(boolean z) {
        ...
        File[] n = n();
        if (n.length <= i) {
            a.a.a.a.c.h().a("CrashlyticsCore", "No open sessions to be closed.");
            return;
        }
        f(a(n[i]));
        f fVar = this.n;
        p B = f.B();
        if (B == null) {
            a.a.a.a.c.h().a("CrashlyticsCore", "Unable to close session. Settings are not loaded.");
        } else {
            a(n, i, B.c);
        }
    }
    ...
    private void a(File[] fileArr, int i, int i2) {
        a.a.a.a.c.h().a("CrashlyticsCore", "Closing open sessions.");
        while (i < fileArr.length) {
            File file = fileArr[i];
            String a = a(file);
            a.a.a.a.c.h().a("CrashlyticsCore", "Closing session: " + a);
            a(file, a, i2);
            i++;
        }
    }
    ...
    private void a(d dVar) {
        if (dVar != null) {
            try {
                ...
                a.a.a.a.c.h().e("CrashlyticsCore", "Error closing session file stream in the presence of an exception", e);
            }
        }
    }
    ...
    private void a(int i) {
        ...
        while (i2 < length) {
            ...
            if (!hashSet.contains(matcher.group(1))) {
                a.a.a.a.c.h().a("CrashlyticsCore", "Trimming open session file: " + name);
                file.delete();
            }
            i2++;
        }
    ...
    private File[] a(String str, File[] fileArr, int i) {
        ...
        a.a.a.a.c.h().a("CrashlyticsCore", String.format(Locale.US, "Trimming down to %d logged exceptions.", new Object[]{Integer.valueOf(i)}));
        a(str, i);
    ...
    void a(File[] fileArr) {
        ...
        for (File file : fileArr) {
            a.a.a.a.c.h().a("CrashlyticsCore", "Found invalid session part file: " + file);
            ...
            a.a.a.a.c.h().a("CrashlyticsCore", "Deleting all part files for invalid session: " + a);
            for (File file2 : a(anonymousClass5)) {
                a.a.a.a.c.h().a("CrashlyticsCore", "Deleting session file: " + file2);
                file2.delete();
            }
        }
    }
    ...
    private void b(Date date, Thread thread, Throwable th) {
        ...
        try {
            String j = j();
            if (j == null) {
                a.a.a.a.c.h().e("CrashlyticsCore", "Tried to write a fatal exception while no session was open.", null);
            ...
            try {
                ...
                closeable = dVar;
                try {
                    a.a.a.a.c.h().e("CrashlyticsCore", "An error occurred in the fatal exception logger", e);
    ...
    private void a(com.b.a.c.a.a.d dVar) {
        ...
        try {
            String k = k();
            if (k == null) {
                a.a.a.a.c.h().e("CrashlyticsCore", "Tried to write a native crash while no session was open.", null);
                i.a(null, "Failed to flush to session begin file.");
                i.a(null, "Failed to close fatal exception file output stream.");
                return;
            }
            ...
            try {
                ...
                e = e2;
                try {
                    a.a.a.a.c.h().e("CrashlyticsCore", "An error occurred in the native crash logger", e);
    ...
    private void c(String str) {
        ...
        try {
            ...
            try {
                ab.a((e) a, this.m.c(), this.n.i(), this.n.l(), this.n.k(), this.m.b(), a.a.a.a.a.b.l.a(this.n.j()).a(), this.q);
    ...
    private void a(File file, String str, int i) {
        boolean z;
        a.a.a.a.c.h().a("CrashlyticsCore", "Collecting session parts for ID " + str);
        File[] a = a(new b(str + "SessionCrash"));
        boolean z2 = a != null && a.length > 0;
        a.a.a.a.c.h().a("CrashlyticsCore", String.format(Locale.US, "Session %s has fatal exception: %s", new Object[]{str, Boolean.valueOf(z2)}));
        ...
        a.a.a.a.c.h().a("CrashlyticsCore", String.format(Locale.US, "Session %s has non-fatal exceptions: %s", new Object[]{str, Boolean.valueOf(z)}));
        if (z2 || z) {
            a(file, str, a(str, a2, i), z2 ? a[0] : null);
        } else {
            a.a.a.a.c.h().a("CrashlyticsCore", "No events present for session ID " + str);
        }
        a.a.a.a.c.h().a("CrashlyticsCore", "Removing session part files for ID " + str);
        a(str);
    }
    ...
    private void a(File file, String str, File[] fileArr, File file2) {
        ...
        try {
            ...
            try {
                ...
                a.a.a.a.c.h().a("CrashlyticsCore", "Collecting SessionStart data for session ID " + str);
                a((e) a, file);
                ...
                e = e2;
                try {
                    a.a.a.a.c.h().e("CrashlyticsCore", "Failed to write session file for session ID: " + str, e);
                    r.a(e, (OutputStream) dVar);
    ...
    private static void a(e eVar, File[] fileArr, String str) {
        ...
        for (File name : fileArr) {
            try {
                a.a.a.a.c.h().a("CrashlyticsCore", String.format(Locale.US, "Found Non Fatal for session ID %s in %s ", new Object[]{str, name.getName()}));
                a(eVar, name);
            } catch (Throwable e) {
                a.a.a.a.c.h().e("CrashlyticsCore", "Error writting non-fatal to session.", e);
            }
        }
    }
    ...
    private void a(e eVar, String str) {
        for (String str2 : g) {
            ...
            if (a.length == 0) {
                a.a.a.a.c.h().e("CrashlyticsCore", "Can't find " + str2 + " data for session ID " + str, null);
            } else {
                a.a.a.a.c.h().a("CrashlyticsCore", "Collecting " + str2 + " data for session ID " + str);
                a(eVar, a[0]);
            }
        }
    }
    ...
    private static void a(e eVar, File file) {
        ...
        a.a.a.a.c.h().e("CrashlyticsCore", "Tried to include a file that doesn't exist: " + file.getName(), null);
    }
