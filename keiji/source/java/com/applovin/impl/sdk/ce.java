...
class ce {
    ...
    private String e() {
        return "com.applovin.sdk." + dm.a(this.a.a()) + ".";
    }
    ...
    public Object a(cd cdVar) {
        ...
        synchronized (this.d) {
            try {
                ...
                this.a.h().d("SettingsManager", "Unable to retrieve value for setting " + cdVar.b() + "; using default...");
                obj = cdVar.c();
            }
        }
        return obj;
    ...
    public void a(cd cdVar, Object obj) {
        if (cdVar == null) {
            ...
            this.b.a("SettingsManager", "Setting update: " + cdVar.b() + " set to \"" + obj + "\"");
        }
    }
    ...
    void a(AppLovinSdkSettings appLovinSdkSettings) {
        ...
        if (appLovinSdkSettings != null) {
            synchronized (this.d) {
                boolean z2;
                boolean z3;
                this.d[cb.i.a()] = Boolean.valueOf(appLovinSdkSettings.c());
                long d = appLovinSdkSettings.d();
                if (d >= 0) {
                    if (d > 0) {
                        j = Math.max(30, d);
                    }
                ...
                String e = appLovinSdkSettings.e();
                if (e == null) {
                    e = "NONE";
                }
                ...
                if (e.equals("NONE")) {
                    ...
                    for (String str : e.split(",")) {
                        if (str.equals(AppLovinAdType.a.a())) {
                            z3 = true;
                        } else if (str.equals(AppLovinAdType.b.a()) || str.contains("INCENT") || str.contains("REWARD")) {
                            z2 = true;
                        } else if (str.equals(NativeAdImpl.b.a())) {
                            z = true;
                        }
                    }
                }
            ...
            while (keys.hasNext()) {
                ...
                if (str != null && str.length() > 0) {
                    try {
                        ...
                        this.b.b("SettingsManager", "Unable to convert setting object ", e2);
                    }
                }
            }
        }
        ...
        synchronized (this.d) {
            for (cd cdVar : cb.a()) {
                try {
                    ...
                    this.b.b("SettingsManager", "Unable to load \"" + cdVar.b() + "\"", e2);
                }
            }
        }
    }
