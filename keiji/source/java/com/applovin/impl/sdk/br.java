...
public class br {
    ...
    private void b(bt btVar) {
        synchronized (this.e) {
            if (this.c.size() < ((Integer) this.a.a(cb.bf)).intValue()) {
                this.c.add(btVar);
                d();
                this.b.a("PersistentPostbackManager", "Enqueued postback: " + btVar);
            } else {
                this.b.c("PersistentPostbackManager", "Persistent queue has reached maximum size; postback retried in memory only." + btVar);
            }
        }
    }
    ...
    private void c(bt btVar) {
        this.b.a("PersistentPostbackManager", "Preparing to submit postback..." + btVar);
        synchronized (this.e) {
            btVar.a(btVar.a() + 1);
            d();
        }
        int intValue = ((Integer) this.a.a(cb.bg)).intValue();
        if (btVar.a() > intValue) {
            this.b.c("PersistentPostbackManager", "Exceeded maximum persisted attempt count of " + intValue + ". Dequeuing postback: " + btVar);
            d(btVar);
            return;
        }
        this.a.r().a(btVar.b(), btVar.c(), new bs(this, btVar));
    }
    ...
    private void d(bt btVar) {
        ...
        this.b.a("PersistentPostbackManager", "Dequeued successfully transmitted postback: " + btVar);
    }
