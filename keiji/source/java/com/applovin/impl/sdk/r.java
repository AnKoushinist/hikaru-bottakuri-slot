...
class r {
    ...
    private String d() {
        ...
        try {
            ...
            return i == 1 ? "portrait" : i == 2 ? String.LANDSCAPE : str;
        } catch (Throwable th) {
            this.a.h().b("DataCollector", "Encountered error while attempting to collect application orientation", th);
            return str;
        }
    }
    ...
    u a() {
        ...
        if (a("android.permission.READ_PHONE_STATE")) {
            ...
            if (telephonyManager != null) {
                ...
                try {
                    uVar.g = URLEncoder.encode(networkOperatorName, c.DEFAULT_CHARSET);
        ...
        try {
            uVar.k = this.b.getPackageManager().getPackageInfo((String) this.a.i().a(cb.bu), 0).versionCode;
        } catch (Throwable th) {
        }
