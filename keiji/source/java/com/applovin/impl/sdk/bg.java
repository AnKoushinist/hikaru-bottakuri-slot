...
public class bg extends bv {
    ...
    Map a() {
        ...
        hashMap.put(NativeAdImpl.c, new bw(((Integer) this.a.a(cb.aJ)).intValue()));
        return hashMap;
    }
    ...
    void a(Object obj, bd bdVar) {
        ...
        appLovinNativeAdLoadListener.a(Arrays.asList(new AppLovinNativeAd[]{(AppLovinNativeAd) bdVar}));
    }

    void a(Object obj, c cVar, int i) {
        ((AppLovinNativeAdLoadListener) obj).a(i);
    }

    public void a(List list) {
        AppLovinNativeAd appLovinNativeAd = (AppLovinNativeAd) list.get(0);
        if (((Boolean) this.a.a(cb.br)).booleanValue()) {
            this.a.s().a(appLovinNativeAd, new bh(this));
        } else {
