    ...
    public void adReceived(AppLovinAd appLovinAd) {
        ...
        for (AppLovinAdLoadListener adReceived : hashSet) {
            try {
                ...
                this.a.e.b("AppLovinAdService", "Unable to notify listener about a newly loaded ad", th);
            }
        }
        for (AppLovinAdUpdateListener a : hashSet2) {
            try {
                a.a(appLovinAd);
            } catch (Throwable th2) {
                this.a.e.b("AppLovinAdService", "Unable to notify listener about an updated loaded ad", th2);
            }
        }
    }
    ...
    public void failedToReceiveAd(int i) {
        ...
        for (AppLovinAdLoadListener failedToReceiveAd : hashSet) {
            try {
                ...
                this.a.e.b("AppLovinAdService", "Unable to notify listener about ad load failure", th);
            }
        }
    }
}
