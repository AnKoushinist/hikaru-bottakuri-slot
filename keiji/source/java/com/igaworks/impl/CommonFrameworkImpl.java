            ...
            if (restoreForNullContext != null && restoreForNullContext.size() > 0) {
                for (JSONObject jSONObject : restoreForNullContext) {
                    ...
                    if (jSONObject.has("param")) {
                        string3 = jSONObject.getString("param");
                    } else {
                        string3 = null;
                    }
                    ...
                    IgawLogger.Logging(context, "IGAW_QA", "ADBrixManager >restore activity for null context : " + string + " / " + string2 + " / " + string3 + "/" + string4, 3, false);
                }
                                    ...
                                    try {
                                        ...
                                        for (String str3 : extras.keySet()) {
                                            if (extras.get(str3) != null) {
                                                str2 = new StringBuilder(String.valueOf(str2)).append(str3).append("=").append(extras.get(str3).toString()).append("&").toString();
                                            }
                                        }
                                        if (str2.length() > 0) {
