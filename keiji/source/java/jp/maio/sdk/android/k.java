...
class k extends VideoView implements OnCompletionListener, OnErrorListener, OnPreparedListener {
    ...
    public void a(bo boVar, x xVar, MaioAdsListenerInterface maioAdsListenerInterface, Activity activity) {
        this.f.countDown();
        this.c = boVar;
        ...
        setVideoPath(xVar.a(xVar.c).getPath());
    }
    ...
    public boolean onError(MediaPlayer mediaPlayer, int i, int i2) {
        bc.a("VideoView#onError", "what=" + i + ", extra=" + i2, null);
        if (isPlaying()) {
            stopPlayback();
        }
        e();
        this.e.onFailed(FailNotificationReason.VIDEO, this.c.b);
        bp.b(FailNotificationReason.VIDEO, String.valueOf(this.d.b));
        this.i.finish();
        return true;
    }
