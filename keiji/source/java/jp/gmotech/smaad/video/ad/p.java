...
class p {
    ...
    private String o(String str) {
        ...
        if (a.a(this.o).a() != null) {
            stringBuilder.append("&advertising_id=").append(a.a(this.o).a());
        }
        stringBuilder.append("&u=").append(a.a(this.o).b());
        return stringBuilder.toString();
    }

    String a() {
        v d = a.a(this.o).d();
        String str = a.a(this.o).c() ? d == v.LAND ? this.d : this.f : d == v.LAND ? this.c : this.e;
        a.a("SmaAdVideoInfo", "[getEndcardUrl] mOrientation : " + d + ", endcardUrl : " + str);
        return str;
    }
