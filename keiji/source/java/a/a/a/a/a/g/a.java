...
abstract class a extends a.a.a.a.a.b.a {
    ...
    public boolean a(d dVar) {
        d b = b(a(b(), dVar), dVar);
        a.a.a.a.c.h().a("Fabric", "Sending app info to " + a());
        if (dVar.j != null) {
            a.a.a.a.c.h().a("Fabric", "App icon hash is " + dVar.j.a);
            a.a.a.a.c.h().a("Fabric", "App icon size is " + dVar.j.c + "x" + dVar.j.d);
        }
        int b2 = b.b();
        a.a.a.a.c.h().a("Fabric", ("POST".equals(b.p()) ? "Create" : "Update") + " app request ID: " + b.b("X-REQUEST-ID"));
    ...
    private d a(d dVar, d dVar2) {
        return dVar.a("X-CRASHLYTICS-API-KEY", dVar2.a).a("X-CRASHLYTICS-API-CLIENT-TYPE", TapjoyConstants.TJC_DEVICE_PLATFORM_TYPE).a("X-CRASHLYTICS-API-CLIENT-VERSION", this.a.a());
    }
