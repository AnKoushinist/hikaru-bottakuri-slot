...
public final class Buffer implements Cloneable, BufferedSink, BufferedSource {
    ...
    public Buffer writeDecimalLong(long j) {
        ...
        int i = j2 < 100000000 ? j2 < RFLConstants.UPDATE_INTERVAL_IN_MILLISECONDS ? j2 < 100 ? j2 < 10 ? 1 : 2 : j2 < 1000 ? 3 : 4 : j2 < RFLConstants.UPDATE_INTERVAL_IN_MILLISECONDS_ON_STAY ? j2 < 100000 ? 5 : 6 : j2 < 10000000 ? 7 : 8 : j2 < 1000000000000L ? j2 < 10000000000L ? j2 < 1000000000 ? 9 : 10 : j2 < 100000000000L ? 11 : 12 : j2 < 1000000000000000L ? j2 < 10000000000000L ? 13 : j2 < 100000000000000L ? 14 : 15 : j2 < 100000000000000000L ? j2 < 10000000000000000L ? 16 : 17 : j2 < 1000000000000000000L ? 18 : 19;
        if (obj != null) {
            i++;
        }
    ...
    public long indexOf(byte b, long j) {
        ...
        do {
            ...
            if (j >= ((long) i)) {
                ...
                for (int i3 = (int) (((long) segment2.pos) + j); i3 < i2; i3++) {
                    if (bArr[i3] == b) {
                        return (j2 + ((long) i3)) - ((long) segment2.pos);
                    }
                }
                j = 0;
            }
