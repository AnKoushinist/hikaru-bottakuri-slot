    ...
    private static synchronized AsyncTimeout awaitTimeout() {
        ...
        synchronized (AsyncTimeout.class) {
            ...
            if (asyncTimeout2 == null) {
                ...
                if (remainingNanos > 0) {
                    long j = remainingNanos / RFLConstants.UPDATE_INTERVAL_IN_MILLISECONDS_ON_STAY;
                    AsyncTimeout.class.wait(j, (int) (remainingNanos - (RFLConstants.UPDATE_INTERVAL_IN_MILLISECONDS_ON_STAY * j)));
                } else {
