...
public class bc {
    public static float a(JSONObject jSONObject, String str, float f, AppLovinSdk appLovinSdk) {
        ...
        try {
            ...
            appLovinSdk.getLogger().e("JsonUtils", "Failed to retrieve float property for key = " + str);
            return f;
        }
    }
    ...
    public static int a(JSONObject jSONObject, String str, int i, AppLovinSdk appLovinSdk) {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                appLovinSdk.getLogger().e("JsonUtils", "Failed to retrieve int property for key = " + str);
            }
        }
        return i;
    }
    ...
    public static String a(JSONObject jSONObject, String str, String str2, AppLovinSdk appLovinSdk) {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                appLovinSdk.getLogger().e("JsonUtils", "Failed to retrieve string property for key = " + str);
            }
        }
        return str2;
    }
    ...
    public static boolean a(JSONObject jSONObject, String str, boolean z, AppLovinSdk appLovinSdk) {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                appLovinSdk.getLogger().e("JsonUtils", "Failed to retrieve boolean property for key = " + str);
            }
        }
        return z;
    }
