...
class cr extends ca implements dl {
    ...
    private void d(Map map) {
        ...
        map.put(TapjoyConstants.TJC_APP_VERSION_NAME, this.f.getDataCollector().b().b);
    ...
    private void h(Map map) {
        ...
        map.put(Constants.PREFKEY_CARR, dm.c(a.g));
        map.put(TapjoyConstants.TJC_DEVICE_COUNTRY_CODE, dm.c(a.f));
        map.put("locale", a.h.toString());
        map.put("model", dm.c(a.a));
        map.put("os", dm.c(a.b));
        map.put(TapjoyConstants.TJC_PLATFORM, RFLConstants.kRFLAPI_H1_Parameter_Platform_AND);
    ...
    private void j(Map map) {
        ...
        if ((!z || ((Boolean) this.f.getSettingsManager().a(cb.aW)).booleanValue()) && AppLovinSdkUtils.isValidString(str)) {
            map.put(Constants.PREFKEY_GAID, str);
        }
    ...
    String c() {
        ...
        stringBuffer.append(Operation.EMPTY_PARAM);
