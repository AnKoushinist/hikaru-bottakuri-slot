...
class da extends ca implements dl {
    ...
    private String a(String str, String str2) {
        File a = this.d.a(str2.replace(Operation.DIVISION, "_"), this.f.getApplicationContext(), true);
        if (a == null) {
            return null;
        }
        if (a.exists()) {
    ...
    private void a(JSONObject jSONObject) {
        ...
        String string = jSONObject.getString(ApiAccessUtil.WEBAPI_KEY_HTML);
        ...
        int a2 = bc.a(jSONObject2, "countdown_length", 0, this.f);
        jSONObject2 = jSONObject;
        float a3 = bc.a(jSONObject2, "close_delay", 0.0f, this.f);
        jSONObject2 = jSONObject;
        float a4 = bc.a(jSONObject2, "close_delay_graphic", a(str, fromString2, a3), this.f);
        ...
        jSONObject2 = jSONObject;
        String a5 = bc.a(jSONObject2, "video_end_url", BuildConfig.FLAVOR, this.f);
        jSONObject2 = jSONObject;
        String a6 = bc.a(jSONObject2, "click_tracking_url", BuildConfig.FLAVOR, this.f);
        jSONObject2 = jSONObject;
        boolean a7 = bc.a(jSONObject2, "dismiss_on_skip", false, this.f);
        jSONObject2 = jSONObject;
        boolean a8 = bc.a(jSONObject2, "video_clickable", false, this.f);
        String a9 = bc.a(jSONObject, TapjoyConstants.TJC_CLICK_URL, BuildConfig.FLAVOR, this.f);
        jSONObject2 = jSONObject;
        String a10 = bc.a(jSONObject2, "mute_image", BuildConfig.FLAVOR, this.f);
        str2 = BuildConfig.FLAVOR;
        try {
            str2 = this.f.getFileManager().a(this.h, a10, false);
        } catch (Exception e4) {
        }
        jSONObject2 = jSONObject;
        String a11 = bc.a(jSONObject2, "unmute_image", BuildConfig.FLAVOR, this.f);
        a10 = BuildConfig.FLAVOR;
        try {
            a10 = this.f.getFileManager().a(this.h, a11, false);
        } catch (Exception e5) {
        }
        ...
        if (jSONObject.has("video_button_properties")) {
            try {
                ...
                try {
                    ...
                    a11 = bc.a(jSONObject2, "video_button_html", BuildConfig.FLAVOR, this.f);
                } catch (Exception e6) {
                }
            } catch (Exception e7) {
                aoVar = null;
        ...
        a(new Builder().setHtml(b).setSize(fromString).setType(fromString2).setVideoFilename(str).setTarget(valueOf).setCloseStyle(a).setVideoCloseDelay(a3).setCloseDelay(a4).setCountdownLength(a2).setCurrentAdIdNumber(j).setClCode(string2).setCompletionUrl(a5).setSupplementalClickTrackingUrl(a6).setMuteImageFilename(str2).setUnmuteImageFilename(a10).setDismissOnSkip(a7).setVideoClickableDuringPlayback(a8).setClickDestinationUrl(a9).setVideoButtonHtmlSource(a11).setVideoButtonProperties(aoVar).build());
    }
