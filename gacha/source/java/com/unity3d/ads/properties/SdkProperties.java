...
public class SdkProperties {
    ...
    public static String getDefaultConfigUrl(String str) {
        return "https://config.unityads.unity3d.com/webview/" + getWebViewBranch() + Operation.DIVISION + str + "/config.json";
    }
    ...
    public static String getLocalWebViewFile() {
        return getCacheDirectory().getAbsolutePath() + Operation.DIVISION + "UnityAdsWebApp.html";
    }
