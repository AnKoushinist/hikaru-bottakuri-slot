...
public class StorageManager {
    ...
    public static boolean init(Context context) {
        ...
        addStorageLocation(StorageType.PUBLIC, cacheDirectory + Operation.DIVISION + SdkProperties.getLocalStorageFilePrefix() + "public-data.json");
        if (!setupStorage(StorageType.PUBLIC)) {
            return false;
        }
        addStorageLocation(StorageType.PRIVATE, cacheDirectory + Operation.DIVISION + SdkProperties.getLocalStorageFilePrefix() + "private-data.json");
