...
public class InitializeThread extends Thread {
    ...
    public static class InitializeStateNetworkError extends InitializeStateError implements IConnectivityListener {
        ...
        private boolean shouldHandleConnectedEvent() {
            if (System.currentTimeMillis() - _lastConnectedEventTimeMs < RFLConstants.UPDATE_INTERVAL_IN_MILLISECONDS || _receivedConnectedEvents > MAX_CONNECTED_EVENTS) {
                return false;
            }
            return true;
        }
        ...
        public InitializeState execute() {
            ...
            if (currentApp != null) {
                ...
                if (currentApp.getWebView() != null) {
                    ...
                    z = conditionVariable.block(RFLConstants.UPDATE_INTERVAL_IN_MILLISECONDS);
                }
                if (!z) {
