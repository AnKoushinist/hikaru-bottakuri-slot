...
class i implements r {
    ...
    public i(b.a.a.a.i iVar, Context context, ScheduledExecutorService scheduledExecutorService, o oVar, e eVar, t tVar) {
        this.h = iVar;
        this.j = context;
    ...
    public void a() {
        ...
        Throwable e;
        if (this.b == null) {
            b.a.a.a.a.b.i.a(this.j, "skipping files send because we don't yet know the target endpoint");
            return;
        }
        b.a.a.a.a.b.i.a(this.j, "Sending all files");
        List e2 = this.k.e();
        int i = 0;
        while (e2.size() > 0) {
            try {
                b.a.a.a.a.b.i.a(this.j, String.format(Locale.US, "attempt to send batch of %d files", new Object[]{Integer.valueOf(e2.size())}));
        ...
        b.a.a.a.a.b.i.a(this.j, "Failed to send batch of analytics files to server: " + e.getMessage(), e);
        i = size;
        if (i == 0) {
            this.k.g();
        }
    ...
    public void d() {
        if (this.m.get() != null) {
            b.a.a.a.a.b.i.a(this.j, "Cancelling time-based rollover because no events are currently being generated.");
    ...
    public boolean c() {
        try {
            ...
            b.a.a.a.a.b.i.a(this.j, "Failed to roll file over.", e);
            return false;
        }
    }
    ...
    void a(long j, long j2) {
        if ((this.m.get() == null ? 1 : null) != null) {
            Runnable iVar = new b.a.a.a.a.d.i(this.j, this);
            b.a.a.a.a.b.i.a(this.j, "Scheduling time based file roll over every " + j2 + " seconds");
            try {
                this.m.set(this.l.scheduleAtFixedRate(iVar, j, j2, TimeUnit.SECONDS));
            } catch (Throwable e) {
                b.a.a.a.a.b.i.a(this.j, "Failed to schedule time based file roll over", e);
            }
        }
    }
}
