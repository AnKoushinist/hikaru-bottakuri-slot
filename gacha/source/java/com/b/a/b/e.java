...
class e extends a {
    ...
    public e(i iVar, String str, String str2, b.a.a.a.a.e.e eVar, g gVar) {
    ...
    public f a(String str, String str2, d dVar) {
        ...
        try {
            ...
            try {
                a = a(a(a2), str, str2);
                b.a.a.a.c.h().a("Beta", "Checking for updates from " + a());
                b.a.a.a.c.h().a("Beta", "Checking for updates query params are: " + a2);
                if (a.c()) {
                    b.a.a.a.c.h().a("Beta", "Checking for updates was successful");
                    fVar = this.b.a(new JSONObject(a.e()));
                    if (a != null) {
                        b.a.a.a.c.h().a("Fabric", "Checking for updates request ID: " + a.b("X-REQUEST-ID"));
                    }
                } else {
                    b.a.a.a.c.h().e("Beta", "Checking for updates failed. Response code: " + a.b());
                    if (a != null) {
                        b.a.a.a.c.h().a("Fabric", "Checking for updates request ID: " + a.b("X-REQUEST-ID"));
                    }
                }
                ...
                e = e2;
                try {
                    b.a.a.a.c.h().e("Beta", "Error while checking for updates from " + a(), e);
                    if (a != null) {
                        b.a.a.a.c.h().a("Fabric", "Checking for updates request ID: " + a.b("X-REQUEST-ID"));
                    }
                    return fVar;
