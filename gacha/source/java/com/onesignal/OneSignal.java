...
public class OneSignal {
    ...
    static void sendOnFocus(long j, boolean z) {
        ...
        try {
            jSONObject.put(TapjoyConstants.TJC_APP_ID, appId);
        ...
        if (registerForPushFired && locationFired && awlFired) {
            new Thread(new Runnable() {
                public void run() {
                    ...
                    newUserState.set(TapjoyConstants.TJC_APP_ID, OneSignal.appId);
                    ...
                    newUserState.set(Constants.PREFKEY_CARR, OneSignal.osUtils.getCarrierName());
    ...
    private static boolean openURLFromNotification(Context context, JSONArray jSONArray) {
        ...
        for (int i = 0; i < length; i++) {
            try {
                ...
                Log(LOG_LEVEL.ERROR, "Error parsing JSON item " + i + Operation.DIVISION + length + " for launching a web URL.", th);
            }
        }
        return z;
    }
    ...
    private static OSNotificationOpenResult generateOsNotificationOpenResult(JSONArray jSONArray, boolean z, boolean z2) {
                    ...
                    if (str == null && jSONObject.has("actionSelected")) {
                        ...
                        if (i == 0) {
                            ...
                            try {
                                ...
                                th = th2;
                                Log(LOG_LEVEL.ERROR, "Error parsing JSON item " + i2 + Operation.DIVISION + length + " for callback.", th);
                                str3 = optString;
                                i3 = i;
                                str2 = str3;
                                i2++;
        ...
        oSNotificationOpenResult.action.type = str != null ? ActionType.ActionTaken : ActionType.Opened;
        if (z2) {
            ...
            try {
                ...
                if (jSONObject.has("custom")) {
                    ...
                    if (jSONObject2.has("i")) {
                        ...
                        jSONObject2.put(TapjoyConstants.TJC_APP_ID, getSavedAppId(context));
