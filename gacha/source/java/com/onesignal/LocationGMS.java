...
class LocationGMS {
    ...
    private static class GoogleApiClientListener implements b, c {
        ...
        public void onConnected(Bundle bundle) {
            ...
            Location lastLocation = h.b.getLastLocation(LocationGMS.mGoogleApiClient.realInstance());
    ...
    static void startGetLocation() {
        if (fallbackFailThread == null) {
            try {
                ...
                mGoogleApiClient = new GoogleApiClientCompatProxy(new a(OneSignal.appContext).a(h.a).a(googleApiClientListener).a(googleApiClientListener).b());
