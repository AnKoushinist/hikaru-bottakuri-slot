...
public class g {
    ...
    private int b(Context context, Intent intent) {
        ...
        try {
            ...
            if (a(context)) {
                startWakefulService = android.support.v4.b.g.startWakefulService(context, intent);
            } else {
    ...
    private void c(Context context, Intent intent) {
        ...
        if (str == null) {
            ...
            if (!context.getPackageName().equals(serviceInfo.packageName) || serviceInfo.name == null) {
                ...
                Log.e("FirebaseInstanceId", new StringBuilder((String.valueOf(valueOf).length() + 94) + String.valueOf(str).length()).append("Error resolving target intent service, skipping classname enforcement. Resolved service was: ").append(valueOf).append(Operation.DIVISION).append(str).toString());
                return;
            }
