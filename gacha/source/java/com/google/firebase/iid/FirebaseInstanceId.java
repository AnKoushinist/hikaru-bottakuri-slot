...
public class FirebaseInstanceId {
    ...
    public static synchronized FirebaseInstanceId getInstance(com.google.firebase.a aVar) {
        ...
        synchronized (FirebaseInstanceId.class) {
            firebaseInstanceId = (FirebaseInstanceId) a.get(aVar.c().a());
            if (firebaseInstanceId == null) {
                ...
                a.put(aVar.c().a(), firebaseInstanceId);
            }
        }
    ...
    a d() {
        return this.d.c().a(BuildConfig.FLAVOR, this.e, Operation.MULTIPLY);
    }

    String e() {
        return a(this.e, Operation.MULTIPLY);
    }
