...
public class AnipangGoodsOfferRewardDialog extends Dialog {
    ...
    private void setOfferMainContents(Context context, LinearLayout linearLayout) {
        ...
        View frameLayout = new FrameLayout(context);
        frameLayout.setLayoutParams(new LinearLayout.LayoutParams(AnipangDialogUtil.convertPixelToDP(context, StatusLine.HTTP_PERM_REDIRECT, true), AnipangDialogUtil.convertPixelToDP(context, 94, false)));
        imageView = new Button(context);
        imageView.setLayoutParams(new FrameLayout.LayoutParams(AnipangDialogUtil.convertPixelToDP(context, StatusLine.HTTP_PERM_REDIRECT, false), AnipangDialogUtil.convertPixelToDP(context, 94, false), 17));
        if (CommonHelper.CheckPermissionForCommonSDK(context)) {
    ...
    private View getSuccessRewardView(final Context context) {
        View linearLayout = new LinearLayout(context);
        ViewGroup.LayoutParams layoutParams = new LinearLayout.LayoutParams(AnipangDialogUtil.convertPixelToDP(context, StatusLine.HTTP_PERM_REDIRECT, true), AnipangDialogUtil.convertPixelToDP(context, 192, false));
        ...
        ViewGroup.LayoutParams layoutParams2 = new LinearLayout.LayoutParams(AnipangDialogUtil.convertPixelToDP(context, StatusLine.HTTP_PERM_REDIRECT, true), AnipangDialogUtil.convertPixelToDP(context, 55, false));
