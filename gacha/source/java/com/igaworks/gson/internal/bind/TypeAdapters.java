...
public final class TypeAdapters {
    ...
    public static final TypeAdapter<BitSet> BIT_SET = new TypeAdapter<BitSet>() {
        ...
        public BitSet read(JsonReader jsonReader) {
            ...
            while (peek != JsonToken.END_ARRAY) {
                boolean z;
                switch (AnonymousClass2.$SWITCH_TABLE$com$igaworks$gson$stream$JsonToken()[peek.ordinal()]) {
    ...
    public static final TypeAdapter<JsonElement> JSON_ELEMENT = new TypeAdapter<JsonElement>() {
        ...
        public JsonElement read(JsonReader jsonReader) {
            ...
            switch (AnonymousClass25.$SWITCH_TABLE$com$igaworks$gson$stream$JsonToken()[jsonReader.peek().ordinal()]) {
    ...
    public static final TypeAdapter<Number> NUMBER = new TypeAdapter<Number>() {
        ...
        public Number read(JsonReader jsonReader) {
            JsonToken peek = jsonReader.peek();
            switch (AnonymousClass11.$SWITCH_TABLE$com$igaworks$gson$stream$JsonToken()[peek.ordinal()]) {
                case AdInfo.BANNER_KIND_BANNER7 /*7*/:
    ...
    class AnonymousClass29 implements TypeAdapterFactory {
        ...
        public String toString() {
            return "Factory[type=" + this.val$boxed.getName() + Operation.PLUS + this.val$unboxed.getName() + ",adapter=" + this.val$typeAdapter + "]";
        }
    }
    ...
    class AnonymousClass30 implements TypeAdapterFactory {
        ...
        public String toString() {
            return "Factory[type=" + this.val$base.getName() + Operation.PLUS + this.val$sub.getName() + ",adapter=" + this.val$typeAdapter + "]";
        }
    }
