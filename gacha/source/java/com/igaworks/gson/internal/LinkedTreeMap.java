...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        public Iterator<Entry<K, V>> iterator() {
            return new LinkedTreeMapIterator<Entry<K, V>>(LinkedTreeMap.this) {
    ...
    class KeySet extends AbstractSet<K> {
        ...
        public Iterator<K> iterator() {
            return new LinkedTreeMapIterator<K>(LinkedTreeMap.this) {
                public K next() {
                    return nextNode().key;
                }
            };
    ...
    static final class Node<K, V> implements Entry<K, V> {
        ...
        public String toString() {
            return this.key + Operation.EQUALS + this.value;
        }
    ...
    Node<K, V> find(K k, boolean z) {
        ...
        if (node3 != null) {
            ...
            throw new ClassCastException(new StringBuilder(String.valueOf(k.getClass().getName())).append(" is not Comparable").toString());
        }
        this.size++;
        this.modCount++;
        return node5;
