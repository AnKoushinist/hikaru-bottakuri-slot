...
public final class C$Gson$Types {
    ...
    private static final class ParameterizedTypeImpl implements Serializable, ParameterizedType {
        ...
        public String toString() {
            ...
            stringBuilder.append(Operation.LESS_THAN).append(C$Gson$Types.typeToString(this.typeArguments[0]));
            for (int i = 1; i < this.typeArguments.length; i++) {
                stringBuilder.append(", ").append(C$Gson$Types.typeToString(this.typeArguments[i]));
            }
            return stringBuilder.append(Operation.GREATER_THAN).toString();
        }
    }
    ...
    public static Type canonicalize(Type type) {
        if (type instanceof Class) {
            ...
            return cls.isArray() ? new GenericArrayTypeImpl(C$Gson$Types.canonicalize(cls.getComponentType())) : cls;
