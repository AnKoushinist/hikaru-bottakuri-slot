...
public class CommerceDB {
    ...
    protected static class CommerceDBOpenHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase sQLiteDatabase) {
            sQLiteDatabase.execSQL(String.format(DATABASE_CREATE_PURCHASE_RESTORE, new Object[]{"_id", "order_id", "product_id", "product_name", "price", "quantity", AppLovinEventParameters.REVENUE_CURRENCY, "category", "create_at", "retry_count", "order_id", "product_id", "product_name", "price", "quantity", AppLovinEventParameters.REVENUE_CURRENCY, "category", "create_at"}));
        }
