...
public class PurchaseRetryDAO extends CommerceDB {
    ...
    public List<PurchaseItem> getRetryPurchase() {
        ...
        try {
            Cursor query = this.db.query(true, "PurchaseRestore", new String[]{"_id", "order_id", "product_id", "product_name", "price", "quantity", AppLovinEventParameters.REVENUE_CURRENCY, "category", "create_at", "retry_count"}, null, null, null, null, null, null);
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        if ((i3 <= -1 || query.getCount() != 0) && query.moveToFirst()) {
                            ...
                            contentValues.put(AppLovinEventParameters.REVENUE_CURRENCY, str10);
