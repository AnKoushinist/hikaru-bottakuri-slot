...
class o implements Listener {
    ...
    void c() {
        ...
        double d = this.a.b.i.g;
        if (d > 0.0d) {
            l.b.a("Media pool at ").a(this.j / 1048576.0d).a(Operation.DIVISION).a(d / 1048576.0d).b((Object) " MB");
        }
    }
    ...
    void f() {
        if (this.a.b.i.j.equals(TapjoyConstants.TJC_CONNECTION_TYPE_WIFI) && !q.a()) {
            l.a.b((Object) "Skipping asset download due to CACHE_FILTER_WIFI");
        } else if (!this.a.b.i.j.equals("cell") || q.b()) {
            while (this.f < 3 && this.g.size() > 0) {
                String str = (String) this.g.remove(0);
                a aVar = (a) this.c.get(str);
                if (aVar != null && (str == null || str.equals(BuildConfig.FLAVOR))) {
        ...
        if (d != 0.0d) {
            while (this.j > this.a.b.i.g) {
                ...
                if (aVar.b != null) {
                    ...
                    aVar.b = null;
                    this.j -= (double) aVar.g;
                    l.b.a("Media pool now at ").a(this.j / 1048576.0d).a(Operation.DIVISION).a(d / 1048576.0d).b((Object) " MB");
                    this.i = true;
                    this.e.a(2.0d);
                } else {
                    return;
    ...
    String a(String str, int i) {
        ...
        if (substring.contains(Operation.DIVISION)) {
            substring = ".0";
        }
        return i + substring;
    }
