...
public class AdColonyBrowser extends Activity {
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (action == 1) {
                if (a(this.c.c, x, y) && AdColonyBrowser.v) {
                    ...
                    this.c.b.loadData(BuildConfig.FLAVOR, "text/html", "utf-8");
    ...
    class c extends View {
        ...
        public c(AdColonyBrowser adColonyBrowser, Activity activity) {
            ...
            this.a.setShadowLayer(3.0f, 0.0f, TapjoyConnectCore.DEFAULT_CURRENCY_MULTIPLIER, -16777216);
        }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.b.setWebChromeClient(new WebChromeClient(this) {
            ...
            public void onProgressChanged(WebView webView, int i) {
                this.a.setProgress(i * GameControllerDelegate.THUMBSTICK_LEFT_X);
            }
