...
class k {
    ...
    static i a(s sVar) {
        try {
            ...
            if (b == '\"' || b == '\'') {
                ...
                b = e.charAt(0);
                if (b == 't' && e.equals(TapjoyConstants.TJC_TRUE)) {
                    return ADCData.a;
                }
                if (b == AppLovinTargetingData.GENDER_FEMALE && e.equals(TapjoyConstants.TJC_FALSE)) {
                    return ADCData.b;
                }
    ...
    static int a(int i) {
        ...
        if (i >= 97 && i <= R.styleable.AppCompatTheme_buttonStyle) {
            return (i - 97) + 10;
        }
        if (i < 65 || i > 70) {
            return 0;
