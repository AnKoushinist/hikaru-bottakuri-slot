...
public class a {
    ...
    public static String a(boolean z, String str, m mVar) {
        ...
        if (z) {
            ...
            trim = mVar.b().trim();
            if (trim.equals(BuildConfig.FLAVOR) && !trim.equals(Operation.EMPTY_PARAM)) {
                return (toASCIIString + (toASCIIString.contains(Operation.EMPTY_PARAM) ? "&" : Operation.EMPTY_PARAM)) + trim;
            }
        }
        toASCIIString = str;
        if (mVar != null) {
