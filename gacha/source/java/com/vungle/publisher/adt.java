...
public final class adt implements MembersInjector<a> {
    static final /* synthetic */ boolean a = (!adt.class.desiredAssertionStatus());
    ...
    private adt(Provider<j.a> provider, Provider<aed.a.a> provider2, Provider<agt> provider3, Provider<aep.a> provider4) {
        if (a || provider != null) {
            this.b = provider;
            if (a || provider2 != null) {
                this.c = provider2;
    ...
    public static MembersInjector<a> a(Provider<j.a> provider, Provider<aed.a.a> provider2, Provider<agt> provider3, Provider<aep.a> provider4) {
        return new adt(provider, provider2, provider3, provider4);
    }
}
