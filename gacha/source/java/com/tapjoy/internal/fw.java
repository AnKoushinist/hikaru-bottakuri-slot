...
public final class fw {
    final q A = new q(this.b, Constants.PREFKEY_GAID);
    ...
    public final String b() {
        ...
        if (string == null) {
            File file = new File(fm.c(this.a), TapjoyConstants.TJC_REFERRER);
            if (file.exists()) {
                try {
            ...
            this.b.edit().putString("ir", string != null ? string : BuildConfig.FLAVOR).commit();
