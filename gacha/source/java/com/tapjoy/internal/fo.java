...
public final class fo extends r {
    private static fo c;

    public static synchronized fo b(Context context) {
        fo foVar;
    ...
    private fo(Context context) {
        super(context, new t() {
            public final String a(Context context) {
                return fw.a(context).b.getString("gcm.senderIds", BuildConfig.FLAVOR);
            }

            public final void a(Context context, String str) {
                p.a(fw.a(context).b, "gcm.senderIds", str);
            }

            public final String b(Context context) {
                return fw.a(context).b.getString("gcm.regId", BuildConfig.FLAVOR);
            }

            public final void b(Context context, String str) {
                p.a(fw.a(context).b, "gcm.regId", str);
            }

            public final boolean c(Context context) {
                return fw.a(context).b.getBoolean("gcm.stale", true);
            }

            public final void a(Context context, boolean z) {
                p.a(fw.a(context).b, "gcm.stale", z);
            }

            public final int d(Context context) {
                return fw.a(context).b.getInt("gcm.appVersion", Integer.MIN_VALUE);
            }

            public final void a(Context context, int i) {
                p.a(fw.a(context).b, "gcm.appVersion", i);
            }

            public final boolean e(Context context) {
                return fw.a(context).b.getBoolean("gcm.onServer", false);
            }
            ...
            public final long f(Context context) {
                return fw.a(context).b.getLong("gcm.onServerExpirationTime", 0);
            }

            public final void a(Context context, long j) {
                Editor edit = fw.a(context).b.edit();
                edit.putLong("gcm.onServerExpirationTime", j);
                edit.commit();
            }

            public final int g(Context context) {
                return fw.a(context).b.getInt("gcm.backoff", 0);
            }

            public final void b(Context context, int i) {
                p.a(fw.a(context).b, "gcm.backoff", i);
            }
        });
    }
    ...
    protected final boolean a(Context context, Intent intent) {
        ...
        if (fp.a(context).b.o) {
            fl flVar = fm.a(context).g;
            a a = flVar.a(i.APP, "push_ignore");
    ...
    private static int a(Bundle bundle, String str, Context context) {
        if (bundle != null) {
            ...
            if (obj != null) {
                ...
                if (fj.a) {
                    ac.a(4, MovieReward_6005.ADNETWORK_NAME, str2, objArr);
                }
            }
        }
        return 0;
