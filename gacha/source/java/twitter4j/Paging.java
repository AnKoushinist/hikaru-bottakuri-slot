...
public final class Paging implements Serializable {
    ...
    static final char[] SMCP = new char[]{'s', AppLovinTargetingData.GENDER_MALE, 'c', 'p'};
    ...
    List<HttpParameter> asPostParameterList(char[] cArr, String str) {
        ...
        addPostParameter(cArr, AppLovinTargetingData.GENDER_MALE, arrayList, "max_id", getMaxId());
