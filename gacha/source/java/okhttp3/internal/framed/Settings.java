...
public final class Settings {
    ...
    private int set;
    private final int[] values = new int[FLOW_CONTROL_OPTIONS];
    ...
    int getInitialWindowSize(int i) {
        return (128 & this.set) != 0 ? this.values[INITIAL_WINDOW_SIZE] : i;
    }

    int getClientCertificateVectorSize(int i) {
        return (256 & this.set) != 0 ? this.values[CLIENT_CERTIFICATE_VECTOR_SIZE] : i;
    }
