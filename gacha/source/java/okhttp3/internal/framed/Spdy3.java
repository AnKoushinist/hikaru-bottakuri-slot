...
public final class Spdy3 implements Variant {
    ...
    static final class Reader implements FrameReader {
        ...
        private void readPing(Handler handler, int i, int i2) {
            ...
            int readInt = this.source.readInt();
            if (this.client != ((readInt & Spdy3.TYPE_SYN_STREAM) == Spdy3.TYPE_SYN_STREAM ? true : Spdy3.TYPE_DATA)) {
                z = false;
            }
    ...
    static final class Writer implements FrameWriter {
        ...
        public synchronized void ping(boolean z, int i, int i2) {
            ...
            synchronized (this) {
                ...
                if (this.client == ((i & Spdy3.TYPE_SYN_STREAM) == Spdy3.TYPE_SYN_STREAM ? Spdy3.TYPE_SYN_STREAM : Spdy3.TYPE_DATA)) {
                    z2 = Spdy3.TYPE_DATA;
                }
                if (z != z2) {
