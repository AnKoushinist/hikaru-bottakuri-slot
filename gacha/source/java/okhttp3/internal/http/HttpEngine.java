...
public final class HttpEngine {
    ...
    class NetworkInterceptorChain implements Chain {
        ...
        public Response proceed(Request request) {
            ...
            if ((code != AppLovinErrorCodes.NO_FILL && code != 205) || access$200.body().contentLength() <= 0) {
                return access$200;
            }
    ...
    public void sendRequest() {
        if (this.cacheStrategy == null) {
            ...
            if (this.networkRequest == null && this.cacheResponse == null) {
                this.userResponse = new Builder().request(this.userRequest).priorResponse(stripBody(this.priorResponse)).protocol(Protocol.HTTP_1_1).code(HttpResponseCode.GATEWAY_TIMEOUT).message("Unsatisfiable Request (only-if-cached)").body(EMPTY_BODY).build();
    ...
    public static boolean hasBody(Response response) {
        ...
        if ((code < 100 || code >= HttpResponseCode.OK) && code != AppLovinErrorCodes.NO_FILL && code != HttpResponseCode.NOT_MODIFIED) {
            return true;
        }
    ...
    private Response readNetworkResponse() {
        ...
        if (String.CLOSE.equalsIgnoreCase(build.request().header("Connection")) || String.CLOSE.equalsIgnoreCase(build.header("Connection"))) {
    ...
    private static boolean validate(Response response, Response response2) {
        if (response2.code() == HttpResponseCode.NOT_MODIFIED) {
            return true;
        }
