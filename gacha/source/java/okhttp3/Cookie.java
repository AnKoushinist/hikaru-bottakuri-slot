...
public final class Cookie {
    ...
    private static boolean pathMatch(HttpUrl httpUrl, String str) {
        ...
        if (encodedPath.startsWith(str) && (str.endsWith(Operation.DIVISION) || encodedPath.charAt(str.length()) == '/')) {
            return true;
        }
        return false;
    }
    ...
    static Cookie parse(long j, HttpUrl httpUrl, String str) {
        ...
        if (str3 == null || !str3.startsWith(Operation.DIVISION)) {
            str3 = httpUrl.encodedPath();
            delimiterOffset = str3.lastIndexOf(47);
            substring = delimiterOffset != 0 ? str3.substring(0, delimiterOffset) : Operation.DIVISION;
        } else {
            substring = str3;
        }
