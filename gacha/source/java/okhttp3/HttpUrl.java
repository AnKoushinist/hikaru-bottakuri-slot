...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        public Builder username(String str) {
            ...
            this.encodedUsername = HttpUrl.canonicalize(str, HttpUrl.USERNAME_ENCODE_SET, false, false, false, true);
            return this;
        }
        ...
        public Builder encodedUsername(String str) {
            ...
            this.encodedUsername = HttpUrl.canonicalize(str, HttpUrl.USERNAME_ENCODE_SET, true, false, false, true);
            return this;
        }
        ...
        public Builder password(String str) {
            ...
            this.encodedPassword = HttpUrl.canonicalize(str, HttpUrl.USERNAME_ENCODE_SET, false, false, false, true);
            return this;
        }
        ...
        public Builder encodedPassword(String str) {
            ...
            this.encodedPassword = HttpUrl.canonicalize(str, HttpUrl.USERNAME_ENCODE_SET, true, false, false, true);
            return this;
        }
        ...
        public Builder fragment(String str) {
            String canonicalize;
            if (str != null) {
                canonicalize = HttpUrl.canonicalize(str, HttpUrl.FRAGMENT_ENCODE_SET, false, false, false, false);
            } else {
                canonicalize = null;
            }
        ...
        public Builder encodedFragment(String str) {
            String canonicalize;
            if (str != null) {
                canonicalize = HttpUrl.canonicalize(str, HttpUrl.FRAGMENT_ENCODE_SET, true, false, false, false);
            } else {
                canonicalize = null;
            }
            this.encodedFragment = canonicalize;
        ...
        ParseResult parse(HttpUrl httpUrl, String str) {
                    ...
                    switch (delimiterOffset != skipTrailingAsciiWhitespace ? str.charAt(delimiterOffset) : '\uffff') {
                        ...
                        case R.styleable.AppCompatTheme_editTextBackground /*64*/:
                            if (obj == null) {
                                ...
                                String canonicalize = HttpUrl.canonicalize(str, i, skipLeadingAsciiWhitespace, HttpUrl.USERNAME_ENCODE_SET, true, false, false, true);
                                if (obj2 != null) {
                                ...
                                if (skipLeadingAsciiWhitespace != delimiterOffset) {
                                    obj = 1;
                                    this.encodedPassword = HttpUrl.canonicalize(str, skipLeadingAsciiWhitespace + 1, delimiterOffset, HttpUrl.USERNAME_ENCODE_SET, true, false, false, true);
                                }
                                obj2 = 1;
                            } else {
                                this.encodedPassword += "%40" + HttpUrl.canonicalize(str, i, delimiterOffset, HttpUrl.USERNAME_ENCODE_SET, true, false, false, true);
                            }
            ...
            if (skipLeadingAsciiWhitespace < skipTrailingAsciiWhitespace && str.charAt(skipLeadingAsciiWhitespace) == '#') {
                this.encodedFragment = HttpUrl.canonicalize(str, skipLeadingAsciiWhitespace + 1, skipTrailingAsciiWhitespace, HttpUrl.FRAGMENT_ENCODE_SET, true, false, false, false);
            }
    ...
    static HttpUrl getChecked(String str) {
        ...
        switch (AnonymousClass1.$SwitchMap$okhttp3$HttpUrl$Builder$ParseResult[parse.ordinal()]) {
    ...
    static int decodeHexDigit(char c) {
        ...
        if (c >= 'a' && c <= AppLovinTargetingData.GENDER_FEMALE) {
            return (c - 97) + 10;
        }
        if (c < 'A' || c > 'F') {
            return -1;
