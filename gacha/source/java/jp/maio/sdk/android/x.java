...
class x {
    private static String a = RFLConstants.kRFLAPI_H1_Parameter_Platform_AND;
    ...
    private static final LocationListener m = new z();
    ...
    public static void a() {
        ...
        f = q.x;
        g = q.y;
        ax.a("SDK API Message", BuildConfig.FLAVOR, "Sdk api init complete.", null);
    }

    public static boolean a(String str) {
        return t.a().getPackageManager().queryIntentActivities(new Intent("android.intent.action.VIEW", Uri.parse(new StringBuilder().append(str).append("://").toString())), 65536).size() > 0;
    }
    ...
    public static boolean b(String str) {
        if (l == null) {
            synchronized (x.class) {
                if (l == null) {
                    l = new HashSet();
                    for (ApplicationInfo applicationInfo : t.a().getPackageManager().getInstalledApplications(0)) {
    ...
    private static DisplayMetrics r() {
        ...
        ((WindowManager) t.a().getSystemService("window")).getDefaultDisplay().getMetrics(displayMetrics);
        return displayMetrics;
    }

    private static String s() {
        String str = BuildConfig.FLAVOR;
        switch (t.a().getResources().getConfiguration().orientation) {
