...
public class GNAdWebActivity extends Activity {
    ...
    class b extends LinearLayout {
        final /* synthetic */ GNAdWebActivity a;
        private Button b = a("Prev", new OnClickListener(this) {
            final /* synthetic */ b a;
        ...
        private Button c = a("Next", new OnClickListener(this) {
            final /* synthetic */ b a;
            ...
            public void onClick(View view) {
                this.a.a.a.goForward();
            }
        });

        public b(GNAdWebActivity gNAdWebActivity, Context context) {
            this.a = gNAdWebActivity;
            super(context);
            setOrientation(0);
            setGravity(16);
            ...
            a("Browser", new OnClickListener(this) {
                ...
                public void onClick(View view) {
                    this.a.a.startActivity(new Intent("android.intent.action.VIEW", Uri.parse(this.a.a.a.getUrl())));
                }
            });
        }
