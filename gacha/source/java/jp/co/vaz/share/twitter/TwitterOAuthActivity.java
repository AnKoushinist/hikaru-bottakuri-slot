package jp.co.vaz.share.twitter;
...
import java.io.File;
import jp.co.vaz.creator.hikaru.AppActivity;
...
public class TwitterOAuthActivity extends Activity {
    ...
    private void c() {
        new AsyncTask<Void, Void, String>(this) {
            ...
            protected String a(Void... voidArr) {
                try {
                    this.a.b = this.a.a.getOAuthRequestToken("hikarutw://twitter");
    ...
    public void onNewIntent(Intent intent) {
        if (intent != null && intent.getData() != null && intent.getData().toString().startsWith("hikarutw://twitter")) {
            this.e = true;
