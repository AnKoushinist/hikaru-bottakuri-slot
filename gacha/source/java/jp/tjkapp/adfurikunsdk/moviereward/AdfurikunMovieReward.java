...
public class AdfurikunMovieReward extends AdfurikunMovie {
    private AdfurikunMovieRewardListener e;
    ...
    public void setAdfurikunMovieRewardListener(AdfurikunMovieRewardListener adfurikunMovieRewardListener) {
        this.e = adfurikunMovieRewardListener;
        this.c.setAdfurikunMovieListener(adfurikunMovieRewardListener);
    }
    ...
    public synchronized void play() {
        if (this.c.mPrevPlaying) {
            ...
            try {
                ...
                if (this.e != null) {
                    this.e.onFailedPlaying((MovieRewardData) (adnetworkWorker != null ? adnetworkWorker.getMovieData() : new MovieRewardData("Unknown", "Play error.")));
                }
            }
        }
    }
