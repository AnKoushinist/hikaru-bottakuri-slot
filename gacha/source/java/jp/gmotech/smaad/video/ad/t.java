...
class t implements h {
    ...
    public void a(long j, String str, int i, String str2) {
        if (i == HttpResponseCode.OK) {
            p pVar = new p();
            pVar.a(this.a.c);
            String replace = str2.replace("&lt;", Operation.LESS_THAN).replace("&gt;", Operation.GREATER_THAN);
            try {
                ...
                replace = this.a.c + replace.substring(replace.lastIndexOf(Operation.DIVISION) + 1);
